...
export const GENRE_HEADLINES: Record<string, string> = {
    action: "Adrenaline Architect",
    adventure: "Journey Junkie",
    animation: "Animation Aficionado",
    comedy: "Punchline Professional",
    crime: "Crime-Drama Kingpin",
    documentary: "Truth Seeker",
    drama: "Prestige Drama Devotee",
    family: "Family-Night MVP",
    fantasy: "Realm Roamer",
    history: "History Buff Supreme",
    horror: "Master of Mayhem",
    music: "Soundtrack Curator",
    mystery: "Plot-Twist Specialist",
    news: "Informed Insider",
    reality: "Reality-TV Ringmaster",
    romance: "Hopeless Romantic (In Best Way)",
    scifi: "Future-World Navigator",
    talk: "Cultural Conversationalist",
    thriller: "Suspense Strategist",
    war: "Battlefield Historian",
    western: "Modern Gunslinger",
};
